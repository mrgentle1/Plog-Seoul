    ...
    >
      <StInformationPage>
        ...
        <InfoContent>
          <img
            className="image"
            src={require("../../assets/images/info1.jpg")}
          />
          <InfoText>
          ...
          <img
            className="image"
            src={require("../../assets/images/info2.jpg")}
          />
          <InfoText>
            <h1>서울둘레길</h1>
            ...
            유적지을 연결해
            <span> 서울의 역사와 문화, 자연생태</span>를 곳곳에서 체험할 수
            있도록 조성하였습니다. <br />
            <br />
          ...
          <img
            className="image"
            src={require("../../assets/images/info3.jpg")}
          />
          <InfoText>
            <h1>한양 도성길</h1>
            한양도성은 1396년 현재{" "}
            ...
            처음 축조된 이후 여러 차례 개축되었다. 평균 높이 약 7~8m, 전체 길이
            약 18.6km에 이르며,{" "}
          ...
          <img
            className="image"
            src={require("../../assets/images/info4.jpg")}
          />
          <InfoText>
            <h1>근교산자락길</h1>
          ...
          <img
            className="image"
            src={require("../../assets/images/info5.jpg")}
          />
          <InfoText>
            <h1>생태문화길</h1>
            주민 및 트래킹 전문가가 참여하여{" "}
            <span>서울시의 역사, 문화, 생태자원</span>이 잘 연계된 걷기 좋은
            코스를 선정한 것으로 서울 전역에 걸쳐 접근성이 용이하고 경관이
            우수한 코스들로 구성되어 있습니다. <br />
            <br />
            2010년 110개 코스를 선정하였고 2011년 23개 코스를 추가하여 총 연장
            851km, 133개 코스를 지정하였습니다.
            <br /> 2012년 전체 지정 노선에 대한 현장 조사를 통해 중복 되거나
            보행이 어려운 노선 등을 삭제하고 지정 노선을 정리하여 현재는 89개
            노선 397km가 등록되어 있습니다. <br />
            <br />
